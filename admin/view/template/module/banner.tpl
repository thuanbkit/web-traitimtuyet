          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><select name="banner_module[<?php echo $module_row; ?>][position]">
                  ...
                  <?php } ?>
				  <?php if ($module['position'] == 'content_top1') { ?>
                  <option value="content_top1" selected="selected">Content Top1</option>
                  <?php } else { ?>
                  <option value="content_top1">Content Top1</option>
                  <?php } ?>
...
function addModule() {	
	...
	html += '      <option value="content_top1">Content Top1</option>';
