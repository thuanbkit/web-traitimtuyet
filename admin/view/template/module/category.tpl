          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><select name="category_module[<?php echo $module_row; ?>][position]">
                ...
                <option value="content_center1" selected="selected">Content Center 1</option>
                <?php } else { ?>
                <option value="content_center1">Content Center 1</option>
                <?php } ?>
...
function addModule() {	
	...
	html += '      <option value="content_top"><?php echo $text_content_top; ?></option>';
        html += '      <option value="content_center1">Content Center1</option>';
