        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            ...
            <td class="left"><select name="facebook_lb_module[<?php echo $module_row; ?>][position]">
                ...
                <option value="content_center1" selected="selected">Giữa nội dung 1</option>
                <?php } else { ?>
                <option value="content_center1">Giữa nội dung 1</option>
                <?php } ?>
...
function addModule() {	
	...
	html += '      <option value="content_center1">Giữa nội dung 1</option>';
