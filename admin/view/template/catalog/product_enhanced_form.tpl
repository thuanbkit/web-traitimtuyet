...
table.formae > tbody > tr > td:first-child {
	width: 100px;
}
table.formae > tbody > tr > td {
	padding: 10px;
	color: #000000;
...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/product.png" alt="" /> <?php if ($eprod3 == 1) { ?><?php echo $heading_title; ?><span class="prodname"></span><span class="prodmodel"></span></h1><?php } else { ?><?php echo $heading_title; ?></h1><?php } ?>
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">          
              <tr>
                ...
                <td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][name]" size="60" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" />
            ...
            <tr>
              <td><?php echo $entry_related; ?></td>
					<td><table>
							...
							<tr>
								<td style="padding: 0;"><select multiple="multiple" id="product" size="10" style="width:350px; height:300px; "></select></td>
								...
								<td style="padding: 0;"><select multiple="multiple" id="related" size="10" style="width:350px; height:300px; "></select></td>
							</tr>
						</table>
