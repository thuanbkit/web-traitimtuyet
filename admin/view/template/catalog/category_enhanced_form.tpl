...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/category.png" alt="" /> <?php if ($ecats5 == 1) { ?><?php echo $heading_title; ?><span class="catname"></span></h1><?php } else { ?><?php echo $heading_title; ?></h1><?php } ?>
    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
<table width="100%" border="0" cellspacing="5" cellpadding="5" style="margin-bottom: 20px;">
  <tr>
    <td width="40%">
            <table class="formae">
              <tr>
             ...
             <tr>
              <td><?php echo $entry_cparent; ?></td>
			  <td><select name="parent_id" style="width:18em;">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><input type="text" name="category_description[<?php echo $language['language_id']; ?>][name]" size="80" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['name'] : ''; ?>" />
