        ...
        <div id="tab-general">
          <table class="form">
			...
			<tr>
              ...
              <td><input type="text" name="config_website" value="<?php echo $config_website; ?>" /></td>
            </tr>
            <tr>
